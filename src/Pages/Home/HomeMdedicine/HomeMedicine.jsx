...
const HomeMedicine = () => {
    ...
    useEffect(() => {
        fetch('https://serpentine-world-server.vercel.app/medicine')
            .then(res => res.json())
            .then(data => {
                setMedicine(data.slice(0,3));
                // setLoading(false);
            })

    }, [])
    return (
        <div className="medicine_container text-white dark:text-black py-32 ">
            ...
            <div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-2 lg:px-16 cards">
                    {
